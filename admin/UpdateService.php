...
include "connection.php";
    ...
    if(isset($_POST['updateService']) && isset($_FILES['image']))
        {
            $id = $_POST['id'];
            $name = $_POST['servicename'];
            $details = $_POST['servicedetail'];
            $price = $_POST['price'];
            ...
            if($error === 0)
            {
                ...
                }else
                {
                    ...
                    if(in_array($img_ex_lower, $img_format_allowed_exs))
                    {
                        ...
                        $query_image1 = "SELECT * FROM service WHERE id='$id'";
                        $result_image1 = mysqli_query($conn,$query_image1);

                        if($result_image1){
                            $query = "UPDATE service SET servicepic='$upload_path', servicename='$name', servicedetail='$details', price='$price' WHERE id='$id'";
